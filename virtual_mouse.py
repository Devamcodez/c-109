...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		cv2.line(image,(finger_tip_x,finger_tip_y),(thumb_x,thumb_y),(255,0,0),2)

		# Draw a CIRCLE on CENTER of the LINE between FINGER TIP and THUMB TIP
		center_x=int((finger_tip_x+thumb_x)/2)
		center_y=int((finger_tip_y+thumb_y)/2)
		cv2.circle(image,(center_x,center_y),2,(0,0,255),2)

		# Calculate DISTANCE between FINGER TIP and THUMB TIP
		distance=math.sqrt(((finger_tip_x-thumb_x)**2)+((finger_tip_y-thumb_y)**2))
		...
		print("Tips line center positio : ",center_x,center_y)
